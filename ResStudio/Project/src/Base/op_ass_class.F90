...
!    TIMING(EVENT_SUBTASK_STARTED,taskid,tlib_taskid,thrdNo)
    ...
    Do i=1,Size(dist%grid,1)
       ...
       End Do
    End Do
!    TIMING(EVENT_SUBTASK_FINISHED,taskid,tlib_taskid,thrdNo)
...
!    TIMING(EVENT_TASK_FINISHED,dm_get_taskid(arg%datamanager),0,0)
...
#ifdef MT_LOG
    Integer(8) :: log_start, log_tmp, log_stop
#endif
...
#ifdef MT_LOG
    call tl_log_time(log_tmp)
    call tl_log_add("op_ass_task_dist "//CHAR(0), log_start, log_tmp)
#endif
...
!-----------------------------------------------------------------------------------------------------------------------------
  Subroutine op_ass_single_task_warmup(arg)
    ...
    Integer(8) :: wait_start, wait_stop
#endif
    taskid = dm_get_taskid(arg%datamanager)
!    TIMING(EVENT_SUBTASK_STARTED,taskid,tlib_taskid,thrdNo)
...
!-------------------------------------------------------------------------------------------------------
  ...
  Subroutine op_ass_single_task(arg)
    ...
    call tl_log_add("op_ass_single_task "//nam//CHAR(0), log_start, log_stop)
#endif

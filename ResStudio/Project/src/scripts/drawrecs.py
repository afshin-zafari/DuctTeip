...
if group == CholSpeedUp:
    ...
    recc= list()
    for np in [512,1024,2048,4096,8192]:
        for nb in [1,2,4,8,16 ,32 ,64,128,256,512,1024,2048]:
            temp=[r[T2_COL] for r in recf if r[NpTot_COL] == np and r[Nc_COL] == 1 and r[Seq_COL] in(3,2) and r[Nb_COL] == nb and r[Nt_COL] ==1]
            if len (temp ) ==0 : 

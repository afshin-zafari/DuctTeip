...
/*-------------------------------------------------------------------------------*/
/*-------------------------------------------------------------------------------*/
bool MailBox::checkDLBEvents(MemoryManager *memman,MailBoxEvent *event,bool *completed ){
...
/*-------------------------------------------------------------------------------*/
/*-------------------------------------------------------------------------------*/
bool MailBox::getEventAsync(MemoryManager *memman,MailBoxEvent *event,bool *completed ){

  int length,source,tag;
  unsigned long handle;
  bool found=false;
  const bool no_wait=false;
  found = comm->probe(&tag,&source,&length,no_wait);
  if (!found){
